	...
	<body class="ui-widget-content">
		...
		<table width="100%">
			<tr style="border: 1px solid red">
				...
				<td>
					添加标签--<span onclick="$('.mainForm').eq(0).toggle();" style="cursor:pointer;">切换显示模式</span>
				</td>
			</tr>
		</table>
		<form METHOD="POST" NAME="fmOperator"
			style="margin-bottom: 0" id="formID"
			action="${basePath }varLabel_add.action">
				...
				<div class="ItemBlock">
					<table align="center" class="mainForm" style="width: 100%;">
						<tr>
							...
							<td>
								<input name="varLabel.name" id="varLabel.name" style="width:98%" type="text"
									size="15" class="InputStyle"
									vl="validate[optional,maxSize[100]]" />
							</td>
					...
					<tr>
						...
						<tr>
							<td >
								<textarea name="varLabel.value" id="myEditor" type="text" vl="validate[required]
									size="15" class="TextareaStyle" cols="50" rows="20" style="width:98%"></textarea>&nbsp;
							</td>
						</tr>
