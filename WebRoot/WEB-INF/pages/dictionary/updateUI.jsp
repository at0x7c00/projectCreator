...
<html>
	...
	<table border="0" style="position:absolute;top:0;right:5;">
		...
		<form METHOD="POST" NAME="fmOperator" id="formID" style="margin-top: 15; margin-bottom: 0" action="${basePath}dictionary_update.action">
			...
			<div class="ItemBlockBorder">
						<table width="100%" class="mainForm">
							<tr>
								...
								<td width="84%" class="TextStyle" align="left" 
									...
									<input type="text" name="dic.title" maxlength="100" class="InputStyle"
										 size="50" value="${dic.title }" id="areaName" vl="validate[required]">
									<font color="red">*</font>
								</td>
							</tr>
							<tr>
							<td width="16%" class="TextStyle" align="right" 
								...
								<td width="84%" class="TextStyle" align="left" 
									valign="middle">
									<input type="text" name="dic.prefix" class="InputStyle" vl="validate[required]" value="${dic.prefix}" id="number"/>
									<font color="red">*</font>
								</td>
							</tr>
							<tr>
								...
								<td width="84%" class="TextStyle" align="left" 
									valign="middle">
									<textarea rows="4" cols="10" name="dic.description" class="TextareaStyle">${dic.description }</textarea>
								</td>
							</tr>	
						</table>
						</div>
						<div id="InputDetailBar">	
							<input type="submit" name="btnSave" value="修改" class="ButtonStyle" onClick="save()" />
