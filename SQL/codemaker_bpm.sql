...
-- ----------------------------
INSERT INTO `t_environmentvariable` VALUES ('1', 'sql_menu_startId', '150', '2');
...
) ENGINE=InnoDB AUTO_INCREMENT=8419 DEFAULT CHARSET=utf8;
...
INSERT INTO `t_template` VALUES ('16', '权限菜单SQL文件', '#${entity.name}-----------------------------------------------\r\nINSERT INTO `sys_function_point` (`id`,`is_display`, `name`, `order_num`, `url`, `parent`)VALUES (\'${sql_menu_startId+(entityIteratorIndex-1)*4}\',1,\'${entity.name}管理\',\'${sql_menu_startId+(entityIteratorIndex-1)*4}\',\'${entity.lowerClassName}/list.do\',\'132\');\r\nINSERT INTO `sys_function_point` (`id`,`is_display`, `name`, `order_num`, `url`, `parent`)VALUES (\'${sql_menu_startId+(entityIteratorIndex-1)*4+1}\',0,\'${entity.name}添加\',\'1\',\'${entity.lowerClassName}/add.do\',\'${sql_menu_startId+(entityIteratorIndex-1)*4}\');\r\nINSERT INTO `sys_function_point` (`id`,`is_display`, `name`, `order_num`, `url`, `parent`)VALUES (\'${sql_menu_startId+(entityIteratorIndex-1)*4+2}\',0,\'删除${entity.name}\',\'2\',\'${entity.lowerClassName}/delete.do\',\'${sql_menu_startId+(entityIteratorIndex-1)*4}\');\r\nINSERT INTO `sys_function_point` (`id`,`is_display`, `name`, `order_num`, `url`, `parent`)VALUES (\'${sql_menu_startId+(entityIteratorIndex-1)*4+3}\',0,\'${entity.name}修改\',\'3\',\'${entity.lowerClassName}/update.do\',\'${sql_menu_startId+(entityIteratorIndex-1)*4}\');\r\n\r\n', null, '2');
