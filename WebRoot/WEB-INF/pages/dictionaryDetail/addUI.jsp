...
<html>
	...
	<table width="100%">
 	...
 	<table border="0" style="position:absolute;top:0;right:5;">
		...
		<form METHOD="POST" NAME="fmOperator" id="formID" style="margin-top: 15; margin-bottom: 0" action="${basePath}dictionaryDetail_add.action" onsubmit="return checkThisForm();">
			...
			<div class="ItemBlockBorder">
						<table width="100%" class="mainForm">
							<tr>
								...
								<td width="84%" class="TextStyle" align="left" 
									...
									<input type="text" name="dicDetail.name" maxlength="100" class="InputStyle"
										 size="50" value="" id="name" vl="validate[required]">
										 <font color="red">*</font>
								</td>
							</tr>
							<tr>
							<td width="16%" class="TextStyle" align="right" 
								...
								<td width="84%" class="TextStyle" align="left" 
									valign="middle">
									<input type="text" name="dicDetail.value" class="InputStyle" value="" id="number"/>
								</td>
							</tr>
							<td width="16%" class="TextStyle" align="right" 
									 valign="middle">
								...
								<td width="84%" class="TextStyle" align="left" 
									valign="middle">
									<input type="text" name="dicDetail.sort" class="InputStyle" vl="validate[custom[number]]" value="" id="sort"/>
								</td>
							</tr>
						</table>
						</div>
						<div id="InputDetailBar">	
						<input type="submit" name="btnSave" value="添加" class="ButtonStyle"/>
