		...
		<form action="${basePath }property_update.action" method="post" id="formID">
			...
			<table width="100%" border="0">
				<tr>
					...
					<td>
						<select name="entityId" id="typeSel" vl="validate[required]">
								<option value="">-请选择-</option>
								<c:forEach items="${entityList}" var="entity">
									<option value="${entity.id }" ${property.entity.id==entity.id?'selected':''}>${entity.fullClassName}</option>
								</c:forEach>
				...
				<tr>
					...
					<td>
						<input type="text" name="property.propName" class="InputStyle" id="fieldName" vl="validate[required,maxSize[20]]"
							value="<c:out value="${property.propName }"/>" /><font color="red"> * ${msg }</font>
					</td>
				</tr>
				<tr>
					<td width="20%" align="right">
				...
				<tr>
					...
					<td>
						<input type="text" name="property.name" class="InputStyle" id="fieldNameCN" vl="validate[required]"
							value="${property.name }" /><font color="red"> *</font>
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td>
						<input type="checkbox" name="property.canNull"   value="1"/> 
					</td>
				</tr>
				<tr>
			           <td width="20%" align="right">
