...
<html>
	...
	<table width="100%">
	  <tr style="border:1px solid red">
		...
		<form id="formID" METHOD="POST" NAME="fmOperator" style="margin-top: 15; margin-bottom: 0" action="${basePath }page_update.action">
